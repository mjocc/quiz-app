<template>
  ...
  <a
    ...
    :href="`https://facebook.com/sharer/sharer.php?u=${encodedLink}`"
    target="_blank"
    rel="noopener"
    aria-label=""
  >
  ...
  <a
    class="resp-sharing-button__link"
    :href="`https://www.tumblr.com/widgets/share/tool?posttype=link&amp;title=${encodedText}&amp;caption=${encodedText}&amp;content=${encodedLink}&amp;canonicalUrl=${encodedLink}&amp;shareSource=tumblr_share_button`"
    target="_blank"
    rel="noopener"
    aria-label=""
  >
  ...
  <a
    class="resp-sharing-button__link"
    :href="`mailto:?subject=${encodedText}&amp;body=${encodedLink}`"
    target="_self"
    rel="noopener"
    aria-label=""
  >
  ...
  <a
    class="resp-sharing-button__link"
    :href="`https://pinterest.com/pin/create/button/?url=${encodedLink}&amp;media=${encodedLink}&amp;description=${encodedText}`"
    target="_blank"
    rel="noopener"
    aria-label=""
  >
  ...
  <a
    class="resp-sharing-button__link"
    :href="`https://reddit.com/submit/?url=${encodedLink}&amp;resubmit=true&amp;title=${encodedText}`"
    target="_blank"
    rel="noopener"
    aria-label=""
  >
  ...
  <a
    class="resp-sharing-button__link"
    :href="`whatsapp://send?text=${encodedText}%20${encodedLink}`"
    target="_blank"
    rel="noopener"
    aria-label=""
  >
  ...
  <a
    class="resp-sharing-button__link"
    :href="`https://news.ycombinator.com/submitlink?u=${encodedLink}&amp;t=${encodedText}`"
    target="_blank"
    rel="noopener"
    aria-label=""
  >
